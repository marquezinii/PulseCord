...
const pulsecordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(pulsecordDir, "Uninstall PulseCord.exe"));

export const DATA_DIR =
    process.env.PULSECORD_USER_DATA_DIR || (PORTABLE ? join(pulsecordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `PulseCord/${app.getVersion()} (https://github.com/marquezinii/PulseCord)`;
