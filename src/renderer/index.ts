...
VesktopLogger.log(`PulseCord v${VesktopNative.app.getVersion()}`);

const { customEntries, customSections } = Vencord.Plugins.plugins.Settings as any as typeof SettingsPlugin;

customEntries.push({
    key: "pulsecord_settings",
    title: "PulseCord Settings",
    Component: SettingsUi,
    Icon: VesktopSettingsIcon
});

customSections.push(() => ({
    section: "PulseCordSettings",
    label: "PulseCord Settings",
    element: SettingsUi,
    className: "vc-pulsecord-settings"
}));
