    ...
    gpointer user_data)
{
    ...
    {
        return g_variant_new_string("pulsecord");
    }
    ...
    else if (g_strcmp0(property_name, "ToolTip") == 0)
    {
        ...
        g_variant_builder_add(&builder, "s", "pulsecord");
...
StatusNotifierItem::StatusNotifierItem()
{
    ...
    service_name = "app.pulsecord.desktop.StatusNotifierItem";
    ...
    gpointer user_data)
{
    ...
    std::cerr << "[libvesktop] Lost ownership of bus name '" << (name ? name : "")
              << "' (likely another PulseCord instance took over). Tray events will stop reaching this process."
              << std::endl;
}
